describe('Account Flow', () => {
    it('should create an account', () => {
        ...
        cy.getElement('company-name').type(`John's Does`)
        cy.getElement('company-phone').type('1234343434')
        cy.getElement('company-email').type('john@business.com')
        cy.getElement('address-1').type('123 Main St')
        cy.getElement('address-city').type('Springfield')
        cy.getElement('address-state').click()
        cy.contains('Arizona').click()
        cy.getElement('company-email').type('john@business.com')
        cy.getElement('company-phone').type('1353453453')
